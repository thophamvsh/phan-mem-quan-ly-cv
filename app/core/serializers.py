    ...
    class Meta:
        ...
        fields = ('id', 'user_id', 'username', 'email', 'is_staff', 'is_superuser', 'first_name', 'last_name', 'full_name', 'ho_ten', 'ho', 'ten', 'phone', 'is_mobile_user',
                 ...
                 'can_view_activity_logs', 'can_view_data_audit_logs',
                  ...
                  'can_view_module_guides', 'can_view_module_guide_history',
                  'can_manage_module_guides', 'can_publish_module_guides',
                 ...
                 'can_delete_shift_device_templates',
                 'can_activate_shift_device_templates',
                 'can_view_shift_summary_templates',
                 'can_create_shift_summary_templates',
                 'can_edit_shift_summary_templates',
                 'can_delete_shift_summary_templates',
                 'can_activate_shift_summary_templates',
                 ...
                 'can_view_admin_shift_duty_rosters', 'can_create_admin_shift_duty_rosters',
                 'can_edit_admin_shift_duty_rosters', 'can_delete_admin_shift_duty_rosters',
                 ...
                 'can_edit_own_diesel_operation_logbooks', 'can_delete_own_diesel_operation_logbooks',
                 ...
                 'can_view_hydrology_settings', 'can_edit_hydrology_settings',
                 'can_use_ai_tools', 'can_use_ai_documents', 'can_receive_alert_notifications')
