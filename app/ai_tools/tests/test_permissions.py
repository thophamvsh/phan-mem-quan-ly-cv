...
class AiToolFactoryScopeTests(TestCase):
    ...
    def test_monthly_production_plan_request_reads_settings_and_production_data(self):
        ...
        self.assertIn("| Sông Hinh | 1.000 | 950 | 850 | -10,53% |", response["response"])
        self.assertIn("| Vĩnh Sơn | 2.000 | 1.800 | 1.650 | -8,33% |", response["response"])
        self.assertIn("| Tổng cộng | 3.000 | 2.750 | 2.500 | -9,09% |", response["response"])
    ...
    def test_year_to_date_production_plan_request_sums_months_until_current_month(self):
        ...
        self.assertIn("| Sông Hinh | 01/2026 | 1.000 | 900 | 800 | -11,11% |", response["response"])
        self.assertIn("| Sông Hinh | 07/2026 | 7.000 | 6.500 | 6.000 | -7,69% |", response["response"])
        self.assertIn("| Tổng cộng | 01-07/2026 | 8.000 | 7.400 | 6.800 | -8,11% |", response["response"])
