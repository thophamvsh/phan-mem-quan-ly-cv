...
def get_factory_config(factory_code):
    """Lay cau hinh dong thong so van hanh dien theo nha may."""
    return get_dien_factory_config(factory_code)
...
class ThongSoVanHanhViewSet(viewsets.ModelViewSet):
    ...
    def config(self, request):
        ...
        if not has_dien_factory_config(factory_code):
            return Response(
